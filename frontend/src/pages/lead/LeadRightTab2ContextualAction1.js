...
const LeadRightTab2ContextualAction1 = ReactRouterDOM.withRouter(function ({ leadAddress, data, updateData, validated }) {
...
export default LeadRightTab2ContextualAction1;
