...
const LeadLeft2Tab1ContextualAction1 = ReactRouterDOM.withRouter(function ({ meeting, data, updateData, validated }) {
...
export default LeadLeft2Tab1ContextualAction1;
