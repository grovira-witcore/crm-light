...
const HomeLeft1Action1 = ReactRouterDOM.withRouter(function ({ data, updateData, validated }) {
        ...
        <div className="d-flex flex-wrap">
          ...
          <div className="pt-2 col-lg-12 col-md-12 col-sm-12 col-12">
            <TextBox
              ...
              regexText={words.invalidLinkedin}
            />
          </div>
          <div className="pt-2 col-lg-6 col-md-12 col-sm-12 col-12">
            <PercentageBox
              label={words.probability}
              value={data.probability}
              onChange={(value) => updateData('probability', value)}
              validated={validated}
              required
            />
          </div>
...
export default HomeLeft1Action1;
