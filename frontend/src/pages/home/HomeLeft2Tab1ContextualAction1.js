...
const HomeLeft2Tab1ContextualAction1 = ReactRouterDOM.withRouter(function ({ meeting, data, updateData, validated }) {
...
export default HomeLeft2Tab1ContextualAction1;
